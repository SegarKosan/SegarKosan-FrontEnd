...
export default function RegisterPage() {
  ...
  const handleGoogleRegister = () => {
    alert("Fitur Daftar dengan Google belum dihubungkan ke Backend.");
  };

  // Mock function untuk navigasi link di preview
        ...
        <div className="p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-500 text-sm mt-1 text-center">
              Daftar untuk mulai memantau kualitas udara kost.
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            {/* Input Nama (Tambahan untuk Register) */}
            <div>
